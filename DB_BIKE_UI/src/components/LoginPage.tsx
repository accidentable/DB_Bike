...
export function LoginPage({ onClose, onSwitchToSignup, onStationFinderClick, onNoticeClick, onCommunityClick, onPurchaseClick, onFaqClick, onHomeClick }: LoginPageProps) {
